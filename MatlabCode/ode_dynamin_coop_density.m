...
function [timepts, conc] = ode_dynamin_coop_density(V, Atotal, Acluster,h, time,...
    kfDRC, Rdilute0, Dsol0, Dmem0, ...
    kfDRD, kfDydy, Rclus0) 
%Dsol0,Dmem0, Rclus0, Rdilute0, h, kfDRC, kfDRD, kfDydy, time)
...
display('Starting Dynamin conc in solution')
Dsol0
display('off rate')
kbDRD
display('KD (uM)')
